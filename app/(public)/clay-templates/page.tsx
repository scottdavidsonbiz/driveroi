...
const TEMPLATES: Template[] = [
  ...
  {
    id: 'compliance-officer-scoring',
    tier: 'walk',
    title: 'Compliance Officer Signal — Scored & Routed',
    useCase: 'Signals & Intent',
    problem: 'You detect new compliance officers via job change signals, but every lead gets the same treatment. A 5-person dental practice and a 200-person orthopedic group both land in the same sequence. Your BDRs waste time on bad-fit leads, and high-value mid-market prospects get generic outreach.',
    description: 'Builds on the Crawl job change detection template by adding company enrichment, SMB vs. mid-market classification based on employee count, conditional work email lookup, and score-based routing. Mid-market companies trigger a Slack alert for personalized BDR outreach. SMB leads route to automated sequences. Unqualified leads get logged but no outreach.',
    timeToValue: '1-2 hours',
    keyBenefit: 'Same signal, different treatment — automatically classify leads as SMB or mid-market and route each to the right motion.',
    ...
    columns: [
      ...
      { name: 'Company Domain', type: 'Signal', source: 'Clay People Source (Sculptor)' },
      { name: 'LinkedIn URL', type: 'Signal', source: 'Clay People Source (Sculptor)' },
      { name: 'Employee Count', type: 'Enrichment', source: 'Enrich Company (native)' },
      { name: 'Industry', type: 'Enrichment', source: 'Enrich Company (native)' },
      { name: 'HQ Location', type: 'Enrichment', source: 'Enrich Company (native)' },
      { name: 'Segment', type: 'Formula', source: 'SMB (<200 employees) vs. Mid-Market (200+)' },
      { name: 'Work Email', type: 'Enrichment', source: 'Find Work Email — conditional on segment' },
      { name: 'Email Status', type: 'Enrichment', source: 'Find Work Email (native workflow)' },
      { name: 'Slack Alert', type: 'Action', source: 'Triggered for mid-market leads only' },
    ],
  },
  {
